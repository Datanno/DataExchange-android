package com.datanno.data.exchange.common.dialog;
...
public class CustomTipDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomTipDialog create() {
            ...
            final CustomTipDialog dialog = new CustomTipDialog(context, R.style.Dialog);
            View layout = inflater.inflate(R.layout.view_common_tip_dialog, null);
