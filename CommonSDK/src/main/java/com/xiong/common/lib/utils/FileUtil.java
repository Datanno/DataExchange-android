...
public class FileUtil {
	...
	public static void createPathForPictures() {
		String paths[] = new String[]{Constants.PATH_TEMP,
				Constants.PATH_IMAGE_CACHE, Constants.PATH_LOG};
		for(String pt: paths){
			String path = Environment.getExternalStorageDirectory().getPath() + pt;
